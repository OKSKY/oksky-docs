...
{"data": {"id": "1", "type": "supports", "links": {...}, "attributes": {...}, "relationships": {...}}}
```
...
{% api-method method="post" host="" path="/rapi/v1/supports" %}
{% api-method-summary %}
create support
{% endapi-method-summary %}
...
{% api-method method="put" host="" path="/rapi/v1/supports/{:id}" %}
{% api-method-summary %}
update supports
{% endapi-method-summary %}
...
{% api-method method="delete" host="" path="/rapi/v1/supports/{:id}" %}
{% api-method-summary %}
delete support
{% endapi-method-summary %}
